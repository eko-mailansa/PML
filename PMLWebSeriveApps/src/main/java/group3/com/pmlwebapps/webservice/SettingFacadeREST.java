...
import group3.com.pmlwebapps.model.Setting;
 ...
 */
@Stateless
@Path("group3.com.pmlwebapps.model.setting")
public class SettingFacadeREST extends AbstractFacade<Setting> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Setting entity) {
        super.edit(entity);
    }
    ...
    public Setting find(@PathParam("id") Integer id) {
