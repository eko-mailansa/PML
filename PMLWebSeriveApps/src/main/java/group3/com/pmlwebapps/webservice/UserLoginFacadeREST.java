...
import group3.com.pmlwebapps.model.UserLogin;
 ...
 */
@Stateless
@Path("group3.com.pmlwebapps.model.userlogin")
public class UserLoginFacadeREST extends AbstractFacade<UserLogin> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, UserLogin entity) {
        super.edit(entity);
    }
    ...
    public UserLogin find(@PathParam("id") String id) {
